...
void SystemInit(void)
{
    ...
    //upper light initial
    g_Device.ULight.Intensity = 70;
    g_Device.ULight.Intensity_I = 70;
    g_Device.ULight.status = 0x0B17;
    //lower light initial
    g_Device.LLight.Intensity = 10;
    g_Device.LLight.Intensity_I = 10;
    g_Device.LLight.status = 0x0B17;
    //colibri
	...
	// parfocal
	g_Device.parfocalEnable = true;
    //motor x,y,z part initial
    g_Device.MotorX.isValid = false;
    g_Device.MotorY.isValid = false;
    g_Device.MotorZ.isValid = false;
...
//  g_Device.MotorZ.Parcenter = -1;
	...
	// focus knob encoder init
	g_Device.HandWheelCode = 0;
